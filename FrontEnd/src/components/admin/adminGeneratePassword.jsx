...
import { GetAllApisAction } from '../../Redux/Action/ApiAction';
                                        ...
                                        <tbody>
                                            {ApiLists.map((ApiLists, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td className="border-0">{ApiLists.key}</td>
                                                    <td className="border-0">{ApiLists.secret}</td>
                                                    <td className="border-0">{ApiLists.clientApiId}</td>
                                                    <td className="border-0">
                                                        <button type="button" className="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal" value={ApiLists.password} onClick={(e) => setPassword(e.target.value)}>
